  ...
  const {
    ...
    onSubmit: async (values: any, actions) => {
      try {
        ...
        let k:any = await addProduct(values)
        console.log("heloo kkkkkkkkkkkkkkk", k)
        if(k) {
          console.log("everything completed", k)
          router.push("/products")
        }

      } catch (error) {
           console.log("error occured while calling add product",error)
           throw error
      }
